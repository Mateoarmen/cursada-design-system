...
(function () {
  ...
  function computeMateria(m, agendaAll) {
    ...
    // Bloque 2: sólo si la materia define exoneración — null significa que
    // no aplica, no se muestra ningún texto en su lugar (ver plan).
    out.exonTxt = e.exoneracion != null ? valU(e.exoneracion, e) : null;
